...
function Forget() {
    ...
    const handleReset = (id, password) => {
        ...
        axios.put(
            ...
            if (response.status === 200) {
                SnackbarEvent('success', 'Reset Password success');
                setTimeout(() => {
                    navigate('/login');
            ...
            if (error.code === 'ECONNABORTED') {
                ...
                SnackbarEvent('error', 'An error occurred while reset password.');
            }
        });
    }
    ...
    return (
        <div>
            <ResetPassword onResetPassword={handleReset} />
